        ...
        <section id="features" className="py-24 bg-slate-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl font-bold text-slate-900 mb-4">Powerful tracking, zero compromise.</h2>
                    <p className="text-lg text-slate-600">Every feature is built with two goals: making tracking effortless and keeping your data exclusively yours.</p>
                </div>
