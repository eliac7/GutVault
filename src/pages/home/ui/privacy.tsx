...
export const Privacy = () => {
  return (
    <section
      id="privacy"
      className="py-24 bg-slate-900 text-slate-50 overflow-hidden relative"
    >
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-900/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800 border border-slate-700 w-fit mb-6">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md bg-slate-800 rounded-3xl p-8 border border-slate-700 shadow-2xl">
              <div className="absolute -top-6 -right-6 w-20 h-20 bg-emerald-500 rounded-2xl flex items-center justify-center shadow-lg transform rotate-12">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="h-12 w-full bg-slate-700/50 rounded-xl flex items-center px-4 border border-slate-600/50">
